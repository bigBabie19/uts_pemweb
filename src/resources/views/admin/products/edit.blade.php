...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.List_Beasiswa.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="name">{{ trans('cruds.List_Beasiswa.fields.name') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.List_Beasiswa.fields.name_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="description">{{ trans('cruds.List_Beasiswa.fields.description') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.List_Beasiswa.fields.description_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="price">{{ trans('cruds.List_Beasiswa.fields.price') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.List_Beasiswa.fields.price_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="stock">{{ trans('cruds.List_Beasiswa.fields.stock') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.List_Beasiswa.fields.stock_helper') }}</span>
            </div>
            <div class="form-group">
                <label>{{ trans('cruds.List_Beasiswa.fields.category') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.List_Beasiswa.fields.category_helper') }}</span>
            </div>
            <div class="form-group">
